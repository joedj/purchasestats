...
@interface PurchaseStatsMSPullToRefreshController ()
...
@property (nonatomic, weak) id <PurchaseStatsMSPullToRefreshDelegate> delegate;

- (void) _checkOffsetsForDirection:(MSRefreshDirection)direction change:(NSDictionary *)change;

@end

@implementation PurchaseStatsMSPullToRefreshController{
